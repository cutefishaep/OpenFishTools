...
$welcome = Join-Path $rootDir "Installer\Mac\resources\welcome.html"
if (Test-Path $welcome) {
    ...
    Write-Host "  [OK] Updated welcome.html" -ForegroundColor Green
}

# 3. Update Mac Conclusion HTML
$conclusion = Join-Path $rootDir "Installer\Mac\resources\conclusion.html"
if (Test-Path $conclusion) {
    ...
    Write-Host "  [OK] Updated conclusion.html" -ForegroundColor Green
}
